    ...
    return (
        <div className="my-32">
            <div className="flex flex-col justify-center">
                ...
                <input name="name" value={formData.name} onChange={handleInputChange} className="m-auto text-white pl-3 py-5 rounded-[15px] bg-transparent border-2 w-[50%] my-5" placeholder="Name" type="text" id="" />
