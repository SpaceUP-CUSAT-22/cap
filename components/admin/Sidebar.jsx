        ...
        {show && <Card className="absolute z-2 md:relative md:z-0 bg-black !rounded-[0px] col-span-1 h-[100%] w-full  p-4 shadow-xl shadow-blue-gray-900/5">
          ...
          <List>
            <ListItem className="text-white text-xl my-5 hover:bg-slate-500 px-3 py-3">
              <Link onClick={() => setShow(show => !show)} href="/admin/add-task">
                  Add task
              </Link>
            </ListItem>
            <ListItem className="text-white text-xl my-5 hover:bg-slate-500 px-3 py-3">
              <Link onClick={() => setShow(show => !show)} href="/admin/add-admin">
                Add new admin
              </Link>
            </ListItem>
            <ListItem className="text-white text-xl my-5 hover:bg-slate-500 px-3 py-3">
              <Link onClick={() => setShow(show => !show)} href="/admin/assign-scores">
                Assign scores
              </Link>
            </ListItem>
            <ListItem onClick={() => {
