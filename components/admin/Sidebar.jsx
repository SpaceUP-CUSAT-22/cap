...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            {show && <Card
                className="absolute z-2 md:relative md:z-0 bg-black !rounded-[0px] col-span-1 h-[100%] w-full  p-4 shadow-xl shadow-blue-gray-900/5">
                <div className="mb-2 p-4">
                    <Link href="/"
                          className='bg-blue-800 mb-10 hover:bg-blue-500 text-white px-3 py-2 rounded-[5px] text-center'>
                        Back
                    </Link>
